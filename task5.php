...
$input= $name.$address.$email.$password.$url.$cv."\n";
$myfile=fopen("forml.txt",'a+') or die("NO DATA TO SHOW");
fwrite($myfile,$input);
 fclose($myfile);

$mydata =  fopen('forml.txt','r')  or die('NO DATA TO SHOW');
    
       echo    fread($mydata,filesize("formal.txt"));
